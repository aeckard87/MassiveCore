...
public class Coll<E extends Entity<E>> extends CollAbstract<E>
{
	...
	public Map<String, Modification> identifiedModifications;
	...
	public synchronized void putIdentifiedModificationFixed(String id, Modification modification)
	{
		...
		/*if (this.getPlugin().getName().equals("Factions") && this.getEntityClass().getName().contains("MPlayer"))
		{
			System.out.println(old);
			System.out.println(modification);
			MUtil.stackTraceDebug("put");
		}*/
	...
	protected boolean examineHasLocalAlterFixed(String id, E entity)
	{
		...
		//if (this instanceof SenderColl) System.out.println(lastRaw);
		//if (this instanceof SenderColl) System.out.println(currentRaw);
		return !MStore.equal(lastRaw, currentRaw);
	}

	@Override
	public Modification syncIdFixed(String id, final Modification mod, Entry<JsonObject, Long> remoteEntry)
	{
		if (id == null) throw new NullPointerException("id");
		
		Modification modification = getActualModification(id, mod, remoteEntry);
		
		if (MStore.DEBUG_ENABLED) System.out.println(this.getDebugName() + " syncronising " + modification + " (" + mod + ") on " + id);
